...
interface SoundtrackOfMonthEditProps {
	link : string
}

export default function TrailerOfWeekEdit({link} : SoundtrackOfMonthEditProps) {
  ...
  return (
	<div>
		...
		<h3 className="text-lg  text-white font-bold mb-2">🎵 Soundtrack του Μήνα</h3>
		<iframe
