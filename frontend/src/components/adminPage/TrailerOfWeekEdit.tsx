...
interface TrailerOfWeekEditProps {
	link : string
}

export default function TrailerOfWeekEdit({link} : TrailerOfWeekEditProps) {
  ...
  return (
	<div>
		...
		<h3 className="text-lg  text-white font-bold mb-2">🎬 Trailer της Εβδομάδας</h3>
		<iframe
